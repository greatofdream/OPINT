...
c
      ...
      double precision  waste, hnext, stpsok, totf, stpcst
...
c
      ! real(kind=8) :: xtab
c      data xtab(1),xtab(2),xtab(3),xtab(4),
c     +     xtab(5),xtab(6),xtab(7)
!       data xtab
!      +    /0.0d0,0.1d0,0.2d0,0.35d0,
!      +     0.5d0,0.7d0,0.8d0/
c
...
c
      l=1
      itab=1
      print *,'output test-table l=',l
      open(8)
      open(9)
      open(90)
      open(91)
      write(8,'(17f9.5)')(rlg(i,itab,l),i=1,nxir)
      write(9,'(50f9.5,$)')(tlk(j),j=1,mt)
      write(9,'(50f9.5)')(tlgtab(j),j=nyis,nyir)
c
      do 120 itab=1,ntab
c
         do 112 j=1,mt
          write(90,'(17f10.5),$')(xderix(itab,j,i,l),i=1,nxir)
          write(91,'(17f10.5)')(91.d0,i=1,nxir)
  112    continue
         do 111 j=nyis,nyir
          write(90,'(17f10.5)')(xderiv(itab,j,i,l),i=1,nxir)
          write(91,'(17f10.5)')(96.d0,i=1,nxir)
  111    continue
c
  120 continue
c
...
c     set index-pointer for opk-array
      ip = (js-1)*md+is
c
      write(*,'(/a,i4,2f6.3)') 'integrate at triple: ',
     +                         ls,rlk(ls,is),tlk(js)
c
      tstart    = xtab(1)
      ystart(1) = zero
...
c
      ...
      write(*,'(/,a,f6.3,/)') 'integration const.: ',const
c
      do 2700 itab=1,ntab
...
c
      ...
      do 7030 itab=1,ntab
       do 7020 js=1,mt
        write(92,'(17f10.5)')(opkx(is,js,itab,ls),is=1,nxir)
 7020  continue
 7030 continue
      close(92)
c
