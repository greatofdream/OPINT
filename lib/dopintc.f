...
c---- between s/r opinit and s/r opintc
      common /arrdim/ nxiv,nyiv,ndatv,ntabv,nzvav,niwkv,nwkv
c
...
c---- common array-dim consistency-check
      if(nxir.ne.nxiv)goto 9710
      if(nyir.ne.nyiv)goto 9720
      if(ndat.ne.ndatv)goto 9730
      if(ntab.ne.ntabv)goto 9740
      if(nzva.ne.nzvav)goto 9750
      if(niwkv.ne.niwkl)goto 9760
      if(nwkv.ne.nwkl)goto 9770
c---- reset iexp
      iexp=0
c---- define ln -> log10
      um = log(10.d0)
...
c
c
9710  print *,'opintc: error in common-array nxir'
      ier=2
      return
9720  print *,'opintc: error in common-array nyir'
      ier=2
      return
9730  print *,'opintc: error in common-array ndat'
      ier=2
      return
9740  print *,'opintc: error in common-array ntab'
      ier=2
      return
9750  print *,'opintc: error in common-array nzva'
      ier=2
      return
9760  print *,'opintc: error in common-array niwkl'
      ier=2
      return
9770  print *,'opintc: error in common-array nwkl'
      ier=2
      return
