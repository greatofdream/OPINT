...
c
c
9710  print *,'opints: error in common-array nxir'
      ier=2
      return
9720  print *,'opints: error in common-array nyir'
      ier=2
      return
9730  print *,'opints: error in common-array ndat'
      ier=2
      return
9740  print *,'opints: error in common-array ntab'
      ier=2
      return
9750  print *,'opints: error in common-array nzva'
      ier=2
      return
9760  print *,'opints: error in common-array niwkl'
      ier=2
      return
9770  print *,'opints: error in common-array nwkl'
      ier=2
      return
c
