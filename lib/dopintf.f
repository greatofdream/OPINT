...
9720  print *,'opintc: error in common-array nyir'
      ier=2
      return
9730  print *,'opintf: error in common-array ndat'
      ier=2
      return
9740  print *,'opintf: error in common-array ntab'
      ier=2
      return
9750  print *,'opintf: error in common-array nzva'
      ier=2
      return
9760  print *,'opintf: error in common-array niwkl'
      ier=2
      return
9770  print *,'opintf: error in common-array nwkl'
      ier=2
      return
