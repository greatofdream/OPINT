...
c
      ! ieeer = ieee_handler ('set', 'invalid', myhandleri)
      ! if (ieeer .ne. 0) print *, 'ieee_handler i cant be set !!'
      ! ieeer = ieee_handler ('set', 'division', myhandlerd)
      ! if (ieeer .ne. 0) print *, 'ieee_handler d cant be set !!'
      ! ieeer = ieee_handler ('set', 'overflow', myhandlero)
      ! if (ieeer .ne. 0) print *, 'ieee_handler o cant be set !!'
      ! ieeer = ieee_handler ('set', 'underflow', myhandleru)
      ! if (ieeer .ne. 0) print *, 'ieee_handler u cant be set !!'
c
c
      itab=1
      write(6,'(A,$)') 
...
c
      integer function myhandlerd (sig, code, context)
      integer sig, code, context(5)
      print 1
      myhandlerd=0
      return
  1   format(' division by zero !!')
      end
c
      integer function myhandleru (sig, code, context)
      integer sig, code, context(5)
      print 1
      myhandleru=0
      return
...
c
      integer function myhandlero (sig, code, context)
      integer sig, code, context(5)
      print 1
      myhandlero=0
      return
...
c
      integer function myhandleri (sig, code, context)
      integer sig, code, context(5)
      print 1
      myhandleri=0
      return
